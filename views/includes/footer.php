    ...
    <div class="info_container">
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            <a href="">
              <img src="views/images/logo.png" alt="only for queens">
            </a>
          </div>
        </div>
        <div class="col-md-3">
          <div class="info_contact">
            <a href="">
              <img src="views/images/location.png" alt="">
              <span>
                Address
              </span>
            </a>
        ...
        <div class="col-md-3">
          <div class="info_contact">
            <a href="">
              <img src="views/images/phone.png" alt="">
              <span>
                +01 1234567890
              </span>
            </a>
        ...
        <div class="col-md-3">
          <div class="info_contact">
            <a href="">
              <img src="views/images/mail.png" alt="">
              <span>
                demo@gmail.com
              </span>
            </a>
